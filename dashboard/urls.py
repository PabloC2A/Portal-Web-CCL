...
urlpatterns = [
    ...
    path("socio/notificaciones/", views.socio_notificaciones, name="socio_notificaciones"), 
    ...
    path("empleado/solicitudes-afiliacion/", views.empleado_solicitudes_afiliacion, name="empleado_solicitudes_afiliacion"),
    path("empleado/convenios/", views.empleado_convenios, name="empleado_convenios"),
    path("empleado/espacios-servicios/", views.empleado_espacios_servicios, name="empleado_espacios_servicios"),
    path("empleado/noticias-eventos/", views.empleado_noticias_eventos, name="empleado_noticias_eventos"),
    path("empleado/metricas/", views.empleado_metricas, name="empleado_metricas"),
    path("empleado/configuracion/", views.empleado_configuracion, name="empleado_configuracion"),
